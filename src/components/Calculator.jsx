    ...
    <section className="flex items-center min-h-screen justify-center">
      <div className="px-2 ">
        <div className=" border p-5 lg:p-10 rounded-lg shadow-lg">
          ...
          <h1 className="flex gap-1 py-1 text-orange-400 items-center text-xs font-bold flex-wrap">NOTE:<p className="text-xs text-white font-normal">Rates are based on the revised rates released on 1/7/2024</p></h1> 
        </div>
      </div>
    </section>
  );
